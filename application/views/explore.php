    ...
    <main id="explore">
        ...
        <li class="explore__user">
                <div class="explore__user-column">
                    <img src="<?php echo asset_url();?>uploads/<?= $res->photo?>" class="explore__avatar"/>
                    <div class="explore__info">
                        <span class="explore__username"><?= $res->username ?></span>
                        <span class="explore__full-name"><?= $res->name ?></span>
                    </div>
                </div>
                <div class="explore__user-column">
