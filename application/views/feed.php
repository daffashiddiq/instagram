    ...
    <main id="feed">
        <?php foreach($dat as $data){?>
            ...
            <header class="photo__header">
                <img src="<?php echo asset_url();?>uploads/<?= $prof->photo?>" class="photo__avatar" />
                <div class="photo__user-info">
                    <span class="photo__author"><?= $data->username ?></span>
                    <span class="photo__location">Bestechung</span>
                </div>
            </header>
            <img src="<?php echo asset_url();?>uploads/<?= $data->url;?>" /> 
            <div class="photo__info">
                ...
                <span class="photo__likes"><?= $data->likes;?> likes</span>
                <span class="photo__caption"><?= $data->caption;?></span>
