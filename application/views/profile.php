    ...
    <main id="profile">
        <header class="profile__header">
            <div class="photo__header">
                <img src="<?php echo asset_url();?>uploads/<?= $dat->photo?>"class="photo__avatar"/>
            </div>
            <div class="profile__column">
                <div class="profile__title">
                    <h3 class="profile__username"><?= $this->session->username ?></h3>
                    <a href="<?= site_url('index.php/home/edit_profile') ?>">Edit profile</a>
                ...
                <p class="profile__bio">
                    ...
                    <a href="#"><?= $dat->website ?></a>
                </p>
            </div>
        </header>
        <section class="profile__photos">
        <?php foreach($pho as $photo){?>
            <div class="profile__photo">
                <img src="<?php echo asset_url();?>uploads/<?= $photo->url ?>" />
